          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className={`text-center max-w-3xl mx-auto transition-all duration-700 ${isLoaded ? 'opacity-100' : 'opacity-0 translate-y-10'}`}>
              ...
              <div className="aspect-video max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 relative group">
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex items-end">
                  <div className="p-6 w-full">
                    <p className="text-white font-medium text-lg opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform translate-y-4 group-hover:translate-y-0">Discover our creative process</p>
                  </div>
                </div>
                <img
